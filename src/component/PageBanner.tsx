                ...
                <div className="container">
                    <div className="dz-bnr-inr-entry d-table-cell">
                        ...
                        <div className="dz-btn">
                            <Link href="tel:+221776600670" className="btn btn-lg btn-icon btn-primary radius-xl btn-shadow mb-3 mb-sm-0">
                                <span className="left-icon"> <i className="feather icon-phone-call" /> </span> +221776600670
                            </Link>
                        </div>
                    </div>
                </div>
