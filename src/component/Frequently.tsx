                        ...
                        <div className="col-xxl-7 col-xl-6 col-lg-5 m-b30 align-self-center">
                            <div className="content-info">
                                <div className="section-head style-1 m-b30">
                                    <h2 className="title wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.7s"> Questions Fréquemment</h2>
                                </div>
                                ...
                                <div className="item1">
                                    <div className="info-widget style-5">
                                        ...
                                        <div className="widget-content">
                                            ...
                                            <Link href="tel:+11234567890" className="text-secondary">+221 77 660 06 70</Link>
                                        </div>
                                    </div>
                                    <Link href="/appointment" className="btn btn-lg btn-icon btn-primary btn-shadow">
                                        <span className="w-100">Rendez-vous</span> <span className="right-icon">
